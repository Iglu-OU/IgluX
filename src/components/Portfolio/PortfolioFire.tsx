...
const PortfolioFire = () => (
    <div className="fire">
        <svg width="388.82" height="655" version="1.1" viewBox="0 0 388.82 655" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <radialGradient
                    id="paint0_radial"
                    cx="0"
                    cy="0"
                    r="1"
                    gradientTransform="matrix(0 185.37 -138.09 0 194.41 469.63)"
                    gradientUnits="userSpaceOnUse"
                >
                    <stop stopColor="#F9C862" offset=".11602" />
                    <stop stopColor="#fff" stopOpacity="0" offset=".95028" />
                </radialGradient>
                <radialGradient
                    id="paint1_radial"
                    cx="0"
                    cy="0"
                    r="1"
                    gradientTransform="matrix(0 260.71 -194.41 0 194.41 374.31)"
                    gradientUnits="userSpaceOnUse"
                >
                    <stop stopColor="#F9C862" offset=".11602" />
                    <stop stopColor="#fff" stopOpacity="0" offset=".95028" />
            ...
            <path
                className="fire-lg"
                d="m205.15 486.03s2.004 17.574-18.541 27.036c0 0-19.543 11.265-13.028 32.894 0 0-7.517-5.407-6.515-15.771 0 0-31.569 43.257 30.066 68.49 0 0 39.588-10.814 35.078-51.818 0 0-2.506 9.462-6.013 13.067 0 0 4.51-12.617-12.528-28.387 0 0-8.519-4.506-2.005-20.277 0 0.44999 7.016-11.265-6.514-25.234z"
                fill="#f05a27"
            />
            <path
                className="fire-md"
                d="m214.3 578.38s2.541-7.214-7.118-15.78c0 0-5.083-2.705-1.016-11.272 0 0 3.558-6.763-4.067-14.428 0 0 1.017 9.919-10.675 15.33 0 0-11.184 6.312-7.117 18.485 0 0-4.067-3.156-3.559-9.017 0 0-12.2 16.682 3.559 30.208 3.558 2.254 8.133 4.058 12.708 5.861 0 0 6.609-1.803 14.234-6.763 4.067-4.508 7.626-10.821 6.609-20.74 0 0.90198-1.525 6.313-3.558 8.116z"
                fill="#f59121"
            />
            <path
                className="fire-sm"
                d="m205.57 594.05c2.63-2.791 4.733-6.976 4.207-13.022 0 0-1.051 3.721-2.103 4.651 0 0 1.577-4.651-4.733-10.231 0 0-3.156-1.86-0.526-7.441 0 0 2.629-4.185-2.63-9.301 0 0 0.526 6.511-6.836 9.766 0 0-7.363 4.185-4.733 12.091 0 0-2.63-1.86-2.63-5.58 0 0-7.362 10.231 1.052 18.602 2.629 1.395 5.785 2.79 9.466 4.185 0.526 0 4.207-0.92999 9.466-3.72z"
                fill="#f7eb20"
            />
